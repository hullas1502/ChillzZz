$( document ).ready(function() {
	var resto_pairs = pairs2;
	var randnum1 = getRandomInt(pairs2.length);
	if(randnum1 < 5){
    ...
    var resto1 = pairs2[randnum1].resto;
	var resto2 = pairs2[randnum2].resto;
	var resto3 = pairs2[randnum3].resto;
	var resto4 = pairs2[randnum4].resto;
	var resto5 = pairs2[randnum5].resto;
	var resto6 = pairs2[randnum6].resto;
	
	var pic1 = pairs2[randnum1].pic;
	var pic2 = pairs2[randnum2].pic;
	var pic3 = pairs2[randnum3].pic;
	var pic4 = pairs2[randnum4].pic;
	var pic5 = pairs2[randnum5].pic;
	var pic6 = pairs2[randnum6].pic;
